...
import { ShieldAlert, User, Building, UserCheck } from 'lucide-react';
...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setIsLoading(true);
    const success = await register(instituteName, adminName, username, password);
    if (success) {
      navigate('/');
    }
    setIsLoading(false);
    ...
    <div className="login-container">
      <div className="login-box" style={{ maxWidth: '480px' }}>
        <div className="login-header">
          ...
          <p>Create your coaching admin account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          <button type="submit" className="login-btn" disabled={isLoading}>
            {isLoading ? 'Creating Account...' : 'Register Institute'}
          </button>
