"""
OMR 50 Questions — OMR Template Generator
Generates: omr_50_template.png
...
Layout (top to bottom):
  ...
  5. Questions: 2 columns × 25 rows (OMR 1-50)
...
# ─────────────────────────────────────────
# 4. Question Columns (2 columns × 25 rows)
# ─────────────────────────────────────────
def draw_questions(img):
    ...
    col_spacing = page_w / 2.0
    columns = [
        {"label": "SECTION 1 (1-25)",  "start": 1,  "cx": PAGE_LEFT + col_spacing * 0.5},
        {"label": "SECTION 2 (26-50)", "start": 26, "cx": PAGE_LEFT + col_spacing * 1.5},
    ]
