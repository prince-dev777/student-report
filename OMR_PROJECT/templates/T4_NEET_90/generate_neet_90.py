"""
NEET 90 Questions — OMR Template Generator
Generates: neet_90_template.png
...
Layout (top to bottom):
  ...
  5. Questions: 3 columns × 30 rows (Biology 1-90)
     - 6 blocks of 5 questions each per column
"""
...
# ─────────────────────────────────────────
# 4. Question Columns (3 columns × 30 rows)
# ─────────────────────────────────────────
def draw_questions(img):
    ...
    columns = [
        {"label": "BIOLOGY COL 1", "start": 1,  "cx": PAGE_LEFT + col_spacing * 0.5},
        {"label": "BIOLOGY COL 2", "start": 31, "cx": PAGE_LEFT + col_spacing * 1.5},
        {"label": "BIOLOGY COL 3", "start": 61, "cx": PAGE_LEFT + col_spacing * 2.5},
    ]
