"""
MHCET 200 Questions (Biology) — OMR Template Generator
Generates: mhcet_200_bio_template.png
...
Layout (top to bottom):
  ...
  5. Questions: 4 columns × 50 rows (MHCET 1-200 with Physics, Chemistry, Biology)
"""
...
def draw_questions(img):
    ...
    columns = [
        ...
        {"label": "BIOLOGY P1",  "start": 101, "cx": PAGE_LEFT + col_spacing * 2.5},
        {"label": "BIOLOGY P2",  "start": 151, "cx": PAGE_LEFT + col_spacing * 3.5},
    ]
...
def generate():
    ...
    out_path = 'mhcet_200_bio_template.png'
