"""
NEET 180 Questions — OMR Template Generator
Generates: neet_180_template.png
...
Layout (top to bottom):
  ...
  5. Questions: 4 columns × 45 rows
     - PHY (1-45), CHEM (46-90), BIO PART 1 (91-135), BIO PART 2 (136-180)
"""
...
# ─────────────────────────────────────────
# 4. Question Columns (4 columns × 45 rows)
# ─────────────────────────────────────────
def draw_questions(img):
    ...
    columns = [
        ...
        {"label": "CHEMISTRY",      "start": 46,  "cx": PAGE_LEFT + col_spacing * 1.5},
        {"label": "BIOLOGY PART 1", "start": 91,  "cx": PAGE_LEFT + col_spacing * 2.5},
        {"label": "BIOLOGY PART 2", "start": 136, "cx": PAGE_LEFT + col_spacing * 3.5},
    ]
    
    y_start = 405.0
    rows_y = [y_start + r * q_gap for r in range(45)]
...
def generate():
    ...
    out_path = 'neet_180_template.png'
